...
export const swaggerSpec = {
  ...
  tags: [
    ...
    {
      name: "Admin",
      description: "Protected admin panel endpoints (Bearer JWT)",
    },
  ...
  paths: {
        ...
        parameters: [
          {
            ...
            description: "2-5 letter currency code",
          },
        ],
        responses: {
          200: {
        ...
        parameters: [
          {
            ...
            in: "path",
            required: true,
            schema: { type: "string", example: "kapitalbank" },
          },
          {
            name: "currency",
            in: "path",
    ...
    "/admin/broadcast": {
      post: {
        ...
        description:
          "Sends text and/or an image to every active subscriber. At least one of text or imageUrl is required.",
        security: [{ bearerAuth: [] }],
        requestBody: {
          required: true,
          content: {
              ...
              schema: {
                ...
                properties: {
                  text: {
                    type: "string",
                    maxLength: 4000,
                    example: "Bugungi kurslar yangilandi!",
                  },
                  imageUrl: {
                    type: "string",
                    format: "uri",
    ...
    "/bot/webhook": {
      post: {
        ...
        description:
          "Receives Telegram updates. Returns 503 if the bot is not configured.",
        responses: {
